      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex space-x-8">
            <a href="#dogs" className="text-gray-700 hover:text-[#018F98]/90">
              Dogs
            </a>
            <a href="#services" className="text-gray-700 hover:text-blue-900">
              Services
            </a>
            <a href="#breeds" className="text-gray-700 hover:text-blue-900">
              Breeds
            </a>
            <a href="#blog" className="text-gray-700 hover:text-blue-900">
              Blog
            </a>
            <a href="#food" className="text-gray-700 hover:text-blue-900">
              Foods
            </a>
          </div>
