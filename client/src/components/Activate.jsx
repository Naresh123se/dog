  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        <img
          src="https://images.pexels.com/photos/4065893/pexels-photo-4065893.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
          alt="Email Verification"
          className="absolute inset-0 w-full h-full object-"
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#0fa7c5b5] to-[#0FA8C5]/50 mix-blend-multiply" />
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <div className="text-black space-y-6 max-w-xl">
            <div className="flex items-center gap-3">
              <Mail size={40} className="text-[#0f39c5c6]" />
          ...
          <div className="text-center space-y-6">
            ...
            <div className="flex justify-center">
              <div className="relative">
                ...
                <ShieldCheck size={64} className="text-[#0FA8C5]" />
                <CheckCircle2
                  size={24}
